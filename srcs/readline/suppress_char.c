...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/05/11 16:51:24 by mblet             #+#    #+#             */
/*   Updated: 2016/05/12 22:07:21 by mblet            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static size_t	s_getlendel(void)
{
	...
	if (sgt_readline()->buffer == NULL)
		return (0);
	len = 0;
	index = getrealindex(sgt_readline()->buffer, sgt_readline()->cursor_pos);
